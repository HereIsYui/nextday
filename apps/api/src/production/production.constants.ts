...
export const itemCatalog: ItemMeta[] = [
  ...
  },
  {
    ...
    tradeable: false,
    usageHint: "基础器材；输入“材料 炼器”可查看可用组合。",
  },
  {
    itemId: "pill_dust",
    name: "丹尘",
    category: "material",
    tradeable: false,
    usageHint: "炼丹失败返还的材料，当前不可直接使用，适合留作后续炼制储备。",
  },
  {
    ...
    category: "equipment_material",
    tradeable: false,
    usageHint: "法宝成长与分解循环材料，适合保留给后续淬炼玩法。",
  },
  {
    itemId: "inscription_rune",
    name: "铭纹砂",
    category: "equipment_material",
    tradeable: false,
    usageHint: "法宝铭刻材料，留待铭刻玩法消耗。",
  },
  {
    itemId: "tower_sigil",
    name: "镇塔符",
    category: "tower_material",
    tradeable: false,
    usageHint: "九塔镇封相关材料，可用于后续塔务与支援玩法。",
  },
  {
    itemId: "demon_crystal",
    name: "九渊残晶",
    category: "tower_material",
    tradeable: false,
    usageHint: "九塔破阵所得的材料，适合留作后续塔务与炼器储备。",
  },
  {
    itemId: "sect_token",
    name: "宗门令",
    category: "sect_material",
    tradeable: false,
    usageHint: "宗门建设与师门任务材料，加入宗门后可发挥作用。",
  },
  {
    itemId: "array_sand",
    name: "阵砂",
    category: "sect_material",
    tradeable: true,
    usageHint: "宗门阵法与协防材料；未绑定时可交易或存入宗门仓库。",
  },
  {
    itemId: "event_travel_note",
    name: "九州游历札",
    category: "material",
    tradeable: false,
    usageHint: "九州游历活动的绑定见闻札记；当前无需主动使用，请留作活动纪念。",
  },
  {
    itemId: "event_danqi_medal",
    name: "丹器试牌",
    category: "material",
    tradeable: false,
    usageHint: "丹器加试活动的绑定参与凭记；当前不可直接消耗，可留作活动纪念。",
  },
  {
    itemId: "event_sect_ribbon",
    name: "同贺绶带",
    category: "sect_material",
    tradeable: false,
    usageHint: "宗门同贺活动的绑定纪念绶带；当前无需主动使用，请留存。",
  },
  {
    itemId: "event_return_pack",
    name: "归山修行囊",
    category: "material",
    tradeable: false,
    usageHint: "归山扶持活动的绑定纪念修行囊；基础资源已随奖励发放，当前无需打开。",
  },
  {
    itemId: "event_comp_letter",
    name: "补偿名帖",
    category: "material",
    tradeable: false,
    usageHint: "维护补偿的绑定凭记；补偿资源已随奖励发放，当前无需主动使用。",
  },
  {
    itemId: "era_medal",
    name: "纪元铭牌",
    category: "material",
    tradeable: false,
    usageHint: "纪元进程奖励的绑定铭牌；当前无需主动使用，请留作纪元见证。",
  },
  {
    itemId: "faction_seal",
    name: "阵营印信",
    category: "sect_material",
    tradeable: false,
    usageHint: "阵营行动奖励的绑定印信；当前无需主动使用，请留作阵营荣誉记录。",
  },
  {
    itemId: "battle_mark",
    name: "战备符",
    category: "battle_material",
    tradeable: false,
    usageHint: "九塔补给与战备整理材料，可留作宗门协防储备。",
  },
  {
    itemId: "spirit_wood",
    name: "灵木",
  ...
  },
  {
    ...
    category: "inner_world_material",
    tradeable: false,
    usageHint: "终局封印与高级内天地支援材料。",
  },
  {
    itemId: "ancient_page",
    name: "九大古宝残页",
    category: "treasure_page",
    tradeable: false,
    usageHint: "可作为九大古宝抽取的消耗材料。",
  },
  {
    ...
    category: "pill",
    tradeable: false,
    usageHint: "可输入“服丹 聚灵丹”直接服用，获得修为。",
  },
  {
    itemId: "pill_feixue_1",
    name: "沸血丹",
    category: "pill",
    tradeable: false,
    usageHint: "可输入“服丹 沸血丹”直接服用，获得修为。",
  },
  {
    itemId: "pill_pojing_1",
    name: "破境丹",
    category: "pill",
    tradeable: false,
    usageHint: "可输入“服丹 破境丹”直接服用，为下一次突破提供辅助药力。",
  },
  {
    ...
    category: "material",
    tradeable: false,
    usageHint: "炼丹专用材料；输入“材料 炼丹”可查看可用组合。",
  },
  {
    itemId: "alch_sunfire_petal",
    name: "赤阳花",
    category: "material",
    tradeable: false,
    usageHint: "炼丹专用材料；输入“材料 炼丹”可查看可用组合。",
  ...
  },
  {
    ...
    category: "equipment_material",
    tradeable: false,
    usageHint: "炼器专用材料；输入“材料 炼器”可查看可用组合。",
  },
  {
  ...
  },
  {
    ...
    category: "pill",
    tradeable: false,
    usageHint: "可输入“服丹 蕴灵丹”直接服用，获得本次炼成的修为药力。",
  },
  {
    ...
    category: "pill",
    tradeable: false,
    usageHint: "可输入“服丹 破障丹”直接服用，为下一次突破提供辅助药力。",
  },
  {
    ...
    category: "pill",
    tradeable: false,
    usageHint: "可输入“服丹 行云丹”直接服用，提升下一次探索的行云增益。",
  },
];
...
export function getItemMeta(itemId: string): ItemMeta {
  return (
    itemCatalog.find((item) => item.itemId === itemId) ?? {
      ...
      category: "unknown",
      tradeable: false,
      usageHint: "暂未记录明确用途，建议先保留并关注后续玩法说明。",
    }
  );
}
